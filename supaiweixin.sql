...
CREATE TABLE IF NOT EXISTS `zuicity_access` (
...
--
-- 转存表中的数据 `zuicity_access`
--

INSERT INTO `zuicity_access` (`role_id`, `node_id`, `pid`, `level`, `module`) VALUES
(5, 17, 11, 3, NULL),
(5, 16, 11, 3, NULL),
(5, 15, 11, 3, NULL),
(5, 14, 11, 3, NULL),
...
CREATE TABLE IF NOT EXISTS `zuicity_adma` (
...
CREATE TABLE IF NOT EXISTS `zuicity_api` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
  `url` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_areply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_article`
--

CREATE TABLE IF NOT EXISTS `zuicity_article` (
...
CREATE TABLE IF NOT EXISTS `zuicity_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_classify`
--

CREATE TABLE IF NOT EXISTS `zuicity_classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_company`
--

CREATE TABLE IF NOT EXISTS `zuicity_company` (
...
--
-- 表的结构 `zuicity_diymen_class`
--

CREATE TABLE IF NOT EXISTS `zuicity_diymen_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
...
--
-- 表的结构 `zuicity_diymen_set`
--

CREATE TABLE IF NOT EXISTS `zuicity_diymen_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_dream` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zuicity_dream`
--

INSERT INTO `zuicity_dream` (`id`, `title`, `content`) VALUES
...
CREATE TABLE IF NOT EXISTS `zuicity_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_function`
--

CREATE TABLE IF NOT EXISTS `zuicity_function` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zuicity_function`
--

INSERT INTO `zuicity_function` (`id`, `gid`, `usenum`, `name`, `funname`, `info`, `isserve`, `status`) VALUES
(1, 1, 0, '天气查询', 'tianqi', '天气查询服务:例  城市名+天气', 1, 1),
(2, 1, 0, '糗事', 'qiushi', '糗事　直接发送糗事', 1, 1),
(3, 1, 0, '计算器', 'jishuan', '计算器使用方法　例：计算50-50　，计算100*100', 1, 1),
(4, 4, 0, '朗读', 'langdu', '朗读＋关键词　例：朗读zuicity多用户营销系统', 1, 1),
...
(32, 4, 0, '官网帐号审核', 'shenhe', '官网帐号审核', 1, 1),
(33, 1, 0, '歌词查询', 'geci', '歌词查询 回复歌词＋歌名即可查询一首歌曲的歌词,例：歌词醉清风', 1, 1),
(34, 2, 0, '域名whois查询', 'yuming', '域名whois查询　回复域名＋域名 可查询网站备案信息,域名whois注册时间等等\r\n 例：域名jiawoyige.com', 1, 1),
(35, 4, 0, '通用预订系统', 'host_kev', '通用预订系统 可用于酒店预订，ktv订房，旅游预订等。', 2, 1),
...
CREATE TABLE IF NOT EXISTS `zuicity_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_host` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_host_list_add`
--

CREATE TABLE IF NOT EXISTS `zuicity_host_list_add` (
...
--
-- 表的结构 `zuicity_host_order`
--

CREATE TABLE IF NOT EXISTS `zuicity_host_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_indent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `zuicity_keyword`
--

CREATE TABLE IF NOT EXISTS `zuicity_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyword` char(255) NOT NULL,
  `pid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_lottery`
--

CREATE TABLE IF NOT EXISTS `zuicity_lottery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_lottery_record`
--

CREATE TABLE IF NOT EXISTS `zuicity_lottery_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_contact`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_coupon`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_create`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_create` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_exchange`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_exchange` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_info`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `info` varchar(200) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_integral`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_set`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_sign`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_sign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
--
-- 表的结构 `zuicity_member_card_vip`
--

CREATE TABLE IF NOT EXISTS `zuicity_member_card_vip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
  `group` tinyint(1) NOT NULL,
...
--
-- 表的结构 `zuicity_nearby_user`
--

CREATE TABLE IF NOT EXISTS `zuicity_nearby_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_node` (
...
--
-- 转存表中的数据 `zuicity_node`
--

INSERT INTO `zuicity_node` (`id`, `name`, `title`, `status`, `remark`, `pid`, `level`, `data`, `sort`, `display`) VALUES
...
(34, 'menu', '左侧栏', 1, '0', 33, 3, NULL, 0, 0),
(33, 'System', '首页', 1, '0', 2, 2, NULL, 0, 0),
(35, 'main', '右侧栏目', 1, '0', 33, 3, NULL, 0, 0),
(36, 'Article', '微信图文', 1, '0', 5, 2, NULL, 0, 2),
(37, 'index', '图文列表', 1, '0', 36, 3, NULL, 0, 2),
(38, 'add', '图文添加', 1, '0', 36, 3, NULL, 0, 2),
(39, 'edit', '微信图文编辑', 1, '0', 36, 3, NULL, 0, 0),
(40, 'del', '微信图文删除', 1, '0', 36, 3, NULL, 0, 0),
(76, 'token', '公众号管理', 1, '0', 1, 2, NULL, 0, 1),
(41, 'Function', '功能模块', 1, '0', 1, 0, NULL, 0, 1),
(42, 'Function', '功能模块', 1, '0', 41, 2, NULL, 0, 2),
(43, 'add', '添加模块', 1, '0', 42, 3, NULL, 0, 2),
(44, 'User_group', '会员组', 1, '0', 3, 2, NULL, 0, 2),
(45, 'add', '添加会员组', 1, '0', 44, 3, NULL, 0, 2),
(46, 'Users', '前台用户', 1, '0', 3, 2, NULL, 0, 2),
(47, 'index', '用户列表', 1, '0', 46, 3, NULL, 0, 0),
(48, 'add', '添加用户', 1, '0', 46, 3, NULL, 0, 2),
(49, 'edit', '编辑用户', 1, '0', 46, 3, NULL, 0, 0),
(50, 'del', '删除用户', 1, '0', 46, 3, NULL, 0, 0),
(51, 'insert', '写入数据库', 1, '0', 46, 3, NULL, 0, 0),
(52, 'upsave', '更新用户', 1, '0', 46, 3, NULL, 0, 0),
(53, 'Text', '微信文本', 1, '0', 5, 2, NULL, 0, 2),
(54, 'index', '文本列表', 1, '0', 53, 3, NULL, 0, 2),
(55, 'del', '删除', 1, '0', 53, 3, NULL, 0, 0),
(56, 'Custom', '自定义页面', 1, '0', 5, 2, NULL, 0, 2),
(57, 'index', '列表', 1, '0', 56, 3, NULL, 0, 2),
(58, 'edit', '编辑', 1, '0', 56, 3, NULL, 0, 0),
(59, 'del', '删除', 1, '0', 56, 3, NULL, 0, 0),
(60, 'Records', '充值记录', 1, '0', 4, 2, NULL, 0, 2),
(61, 'index', '充值列表', 1, '0', 56, 3, NULL, 0, 2),
(62, 'Case', '用户案例', 1, '0', 4, 2, NULL, 0, 2),
(63, 'index', '案例列表', 1, '0', 62, 3, NULL, 0, 2),
(64, 'add', '添加案例', 1, '0', 62, 3, NULL, 0, 2),
(65, 'edit', '编辑案例', 1, '0', 62, 3, NULL, 0, 0),
(66, 'del', '删除案例', 1, '0', 62, 3, NULL, 0, 0),
(67, 'insert', '写入数据库', 1, '0', 62, 3, NULL, 0, 0),
(68, 'upsave', '更新数据库', 1, '0', 62, 3, NULL, 0, 0),
(69, 'Links', '友情链接', 1, '0', 4, 2, NULL, 0, 2),
(70, 'index', '友情链接', 1, '0', 68, 3, NULL, 0, 2),
(71, 'add', '添加链接', 1, '0', 68, 3, NULL, 0, 2),
(72, 'edit', '编辑链接', 1, '0', 68, 3, NULL, 0, 0),
(73, 'insert', '插入数据库', 1, '0', 68, 3, NULL, 0, 0),
(74, 'upsave', '更新数据库', 1, '0', 68, 3, NULL, 0, 0),
(75, 'del', '删除友情链接', 1, '0', 68, 3, NULL, 0, 0),
(78, 'alipay', '在线支付接口', 1, '0', 6, 3, NULL, 0, 2),
(77, 'Token', '公众号管理', 1, '0', 76, 2, NULL, 0, 2);
...
CREATE TABLE IF NOT EXISTS `zuicity_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_ordering_class`
--

CREATE TABLE IF NOT EXISTS `zuicity_ordering_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_ordering_set`
--

CREATE TABLE IF NOT EXISTS `zuicity_ordering_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(10) NOT NULL,
  `title` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 转存表中的数据 `zuicity_other`
--

INSERT INTO `zuicity_other` (`id`, `token`, `keyword`, `info`) VALUES
(1, 'tbsswi1383827218', '我我我', '我我我');
...
CREATE TABLE IF NOT EXISTS `zuicity_photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(20) NOT NULL,
  `picurl` varchar(100) NOT NULL,
...
--
-- 表的结构 `zuicity_photo_list`
--

CREATE TABLE IF NOT EXISTS `zuicity_photo_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
  `title` varchar(20) NOT NULL,
...
--
-- 表的结构 `zuicity_product`
--

CREATE TABLE IF NOT EXISTS `zuicity_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_product_cart`
--

CREATE TABLE IF NOT EXISTS `zuicity_product_cart` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `zuicity_product_cart_list`
--

CREATE TABLE IF NOT EXISTS `zuicity_product_cart_list` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_product_cat`
--

CREATE TABLE IF NOT EXISTS `zuicity_product_cat` (
...
--
-- 表的结构 `zuicity_product_diningtable`
--

CREATE TABLE IF NOT EXISTS `zuicity_product_diningtable` (
  `id` mediumint(4) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `zuicity_reply_info`
--

CREATE TABLE IF NOT EXISTS `zuicity_reply_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `zuicity_requestdata`
--

CREATE TABLE IF NOT EXISTS `zuicity_requestdata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `year` int(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_role` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zuicity_role`
--

INSERT INTO `zuicity_role` (`id`, `name`, `pid`, `status`, `sort`, `remark`) VALUES
(1, '超级管理员', 0, 1, 0, ''),
(2, '演示组', 0, 1, 0, ''),
(3, '普通会员', 0, 1, 0, '');
...
--
-- 表的结构 `zuicity_role_user`
--

CREATE TABLE IF NOT EXISTS `zuicity_role_user` (
...
--
-- 表的结构 `zuicity_selfform`
--

CREATE TABLE IF NOT EXISTS `zuicity_selfform` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_selfform_input`
--

CREATE TABLE IF NOT EXISTS `zuicity_selfform_input` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `zuicity_selfform_value`
--

CREATE TABLE IF NOT EXISTS `zuicity_selfform_value` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `formid` int(10) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `zuicity_snccode`
--

CREATE TABLE IF NOT EXISTS `zuicity_snccode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(1) NOT NULL,
  `status` int(1) NOT NULL,
...
--
-- 表的结构 `zuicity_system_info`
--

CREATE TABLE IF NOT EXISTS `zuicity_system_info` (
...
CREATE TABLE IF NOT EXISTS `zuicity_taobao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `zuicity_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `keyword` char(255) NOT NULL,
...
--
-- 表的结构 `zuicity_token_open`
--

CREATE TABLE IF NOT EXISTS `zuicity_token_open` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
--
-- 转存表中的数据 `zuicity_token_open`
--

INSERT INTO `zuicity_token_open` (`id`, `uid`, `token`, `queryname`) VALUES
(1, 2, 'tbsswi1383827218', 'tianqi,jishuan,jiankang,kuaidi,xiaohua,peiliao,liaotian,shouji,fujin,fanyi,suanming,shouye,adma,geci,qiushi'),
(2, 2, 'hjlelm1386576268', 'tianqi,qiushi,jishuan,jiankang,kuaidi,xiaohua,peiliao,liaotian,shouji,fujin,fanyi,suanming,shouye,adma,geci');
...
CREATE TABLE IF NOT EXISTS `zuicity_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zuicity_user`
--

INSERT INTO `zuicity_user` (`id`, `username`, `password`, `role`, `status`, `remark`, `last_login_time`, `last_login_ip`, `last_location`) VALUES
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 5, 1, '', 1386406103, '127.0.0.1', '');

-- --------------------------------------------------------

--
-- 表的结构 `zuicity_userinfo`
--

CREATE TABLE IF NOT EXISTS `zuicity_userinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
  `wechaname` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gid` int(11) NOT NULL,
...
--
-- 转存表中的数据 `zuicity_users`
--

INSERT INTO `zuicity_users` (`id`, `gid`, `username`, `password`, `email`, `createtime`, `lasttime`, `status`, `createip`, `lastip`, `diynum`, `activitynum`, `card_num`, `card_create_status`, `money`, `viptime`, `connectnum`, `wechat_card_num`) VALUES
(1, 1, 'dddd', 'e10adc3949ba59abbe56e057f20f883e', 'ddd@cc.com', '1383822773', '1383822773', '0', '113.200.56.44', '113.200.56.44', 0, 0, 0, 0, 0, '1383822773', 0, 0),
(2, 4, 'weesh', 'e10adc3949ba59abbe56e057f20f883e', 'luanle8@126.com', '1383827023', '1386576260', '1', '121.235.40.223', '183.5.177.164', 0, 0, 0, 0, 0, '1383753600', 0, 2),
(3, 1, 'cccccc', 'e10adc3949ba59abbe56e057f20f883e', '659314936@qq.com', '1386401897', '1386405496', '1', '127.0.0.1', '127.0.0.1', 0, 0, 0, 0, 0, '1386401897', 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `zuicity_user_group`
--

CREATE TABLE IF NOT EXISTS `zuicity_user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `zuicity_user_group`
--

INSERT INTO `zuicity_user_group` (`id`, `name`, `diynum`, `connectnum`, `iscopyright`, `activitynum`, `price`, `statistics_user`, `create_card_num`, `status`, `wechat_card_num`) VALUES
(1, 'vip0', 2000, 2000, 0, 0, 0, 0, 10, 1, 4),
(2, 'VIP1', 3000, 3000, 1, 2, 1, 0, 50, 1, 4),
(3, 'vip2', 40000, 40000, 1, 4, 50, 0, 80, 1, 4),
(4, 'vip3', 5000, 5000, 0, 5, 300, 0, 1000, 1, 4);

-- --------------------------------------------------------

--
-- 表的结构 `zuicity_user_request`
--

CREATE TABLE IF NOT EXISTS `zuicity_user_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `uid` varchar(32) NOT NULL,
  `keyword` varchar(100) NOT NULL,
...
--
-- 表的结构 `zuicity_voiceresponse`
--

CREATE TABLE IF NOT EXISTS `zuicity_voiceresponse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
--
-- 表的结构 `zuicity_weather`
--

CREATE TABLE IF NOT EXISTS `zuicity_weather` (
...
--
-- 转存表中的数据 `zuicity_weather`
--

INSERT INTO `zuicity_weather` (`id`, `code`, `name`) VALUES
(1, '101010100', '北京'),
(2, '101010200', '海淀'),
(3, '101010400', '顺义'),
(4, '101010500', '怀柔'),
...
--
-- 表的结构 `zuicity_wecha_user`
--

CREATE TABLE IF NOT EXISTS `zuicity_wecha_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zuicity_wxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信公共帐号' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `zuicity_wxuser`
--

INSERT INTO `zuicity_wxuser` (`id`, `uid`, `wxname`, `wxid`, `weixin`, `headerpic`, `token`, `province`, `city`, `qq`, `wxfans`, `typeid`, `typename`, `tongji`, `createtime`, `tpltypeid`, `updatetime`, `tpltypename`, `tpllistid`, `tpllistname`, `tplcontentid`, `tplcontentname`, `allcardnum`, `yetcardnum`, `cardisok`, `totalcardnum`) VALUES
(1, 2, '锐拉百科', 'gh_0a9b5b8ce20a', 'ruilabaike', './themes/User/default/common/images/portrait.jpg', 'tbsswi1383827218', '江苏省', '无锡市', '1383827218@248web.20hx.co', 0, 7, '生活', '', '1383827400', '1', '1383827400', 'ty_index', '1', 'yl_list', '1', 'ktv_content', 10, 0, 1, 0),
(2, 2, '触看科技', 'gh_8b3f8451b765', 'chukanapp', './themes/User/default/common/images/portrait.jpg', 'hjlelm1386576268', '广东', '广州', 'test@test.com', 0, 4, 'IT', '', '1386576730', '1', '1386576730', 'ty_index', '1', 'yl_list', '1', 'ktv_content', 0, 0, 0, 0);
